    ...
    fn from_match(kind: &syntax::MatchKind) -> Self {
        ...
        match highlight {
            ...
            TokenKind::Atom(atom) => match atom {
                ...
                AtomKind::Function => Self::Function,
                AtomKind::Property => Self::Property,
                AtomKind::Number => Self::Number,
                AtomKind::Constant => Self::Constant,
                AtomKind::Variable => Self::Variable,
                AtomKind::Operator => Self::Operator,
                AtomKind::Punctuation => Self::Punctuation,
                AtomKind::Tag => Self::Tag,
                AtomKind::Attribute => Self::Attribute,
                AtomKind::Parameter => Self::Parameter,
                AtomKind::Constructor => Self::Constructor,
                AtomKind::Namespace => Self::Namespace,
                AtomKind::Decorator => Self::Decorator,
                AtomKind::Label => Self::Label,
